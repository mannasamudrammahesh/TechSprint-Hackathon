...
export default function Home() {
    ...
    return (
        <main className="px-4 md:px-8 lg:px-10 flex flex-col md:flex-row justify-around items-center gap-6 md:gap-4 pt-12 md:pt-0 pb-4 md:py-0">
            <Toaster />
            {}
            <div className="w-full md:hidden flex justify-center order-1 mt-8">
                <Image
                    src="/neurology.png"
