  ...
  return (
    <div className={`${showMenu ? "overflow-hidden h-screen" : ""}`}>
      <nav className={`relative ${styles.mobileNavbar}`}>
        <div className="flex px-4 py-3 pt-6 md:p-10 items-center justify-between font-bold pb-4 md:pb-40">
          <div className="flex items-center gap-3">
            <Link href="/" className="flex items-center ">
              <HealixLogo width={28} height={28} textSize="text-xl md:text-2xl" className="md:w-[35px] md:h-[35px]" />
            </Link>
          </div>
          <div
            ...
            onClick={toggleMenu}
          >
            <div className={`w-6 md:w-8 h-0.5 md:h-1 bg-black ${styles.menuli}`}></div>
            <div className={`w-6 md:w-8 h-0.5 md:h-1 bg-black ${styles.menuli}`}></div>
            <div className={`w-6 md:w-8 h-0.5 md:h-1 bg-black ${styles.menuli}`}></div>
          </div>
