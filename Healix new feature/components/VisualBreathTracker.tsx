...
const VisualBreathTracker: React.FC<VisualBreathTrackerProps> = ({ onBreathUpdate }) => {
  ...
  return (
    <div className="absolute top-4 right-4 z-50">
      <div className={`relative overflow-hidden rounded-lg border border-cyan-500/30 bg-black/50 backdrop-blur-sm transition-all duration-300 ${permissionGranted ? 'w-32 h-24' : 'w-auto p-4'}`}>
