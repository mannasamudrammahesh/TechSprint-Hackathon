        ...
        <div className="flex p-4 md:p-6 lg:p-10 items-center justify-between font-bold">
          ...
          >
            ...
            <div className="relative" ref={userMenuRef}>
              ...
              >
                <div 
                  className="w-8 h-8 md:w-10 md:h-10 rounded-full flex items-center justify-center text-white font-bold text-sm md:text-base shadow-md hover:shadow-lg transition-all hover:scale-105"
